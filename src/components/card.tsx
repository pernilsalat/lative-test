...
export function Card({ state, growth, measure }: Props): JSX.Element {
  return (
    <Container
      className='square border border-secondary d-flex text-white text-capitalize justify-content-evenly'
      style={{ backgroundColor: '#3492B3', width: '515px', height: '100px' }}>
      <Col md='auto'>
